...
<div class="row">
  <div class="col-md-12">
    ...
    <li class="nav-item"><a class="nav-link" href="{{url('account-settings')}}"><i class="ti-xs ti ti-users me-1"></i> Account</a></li>
      <li class="nav-item"><a class="nav-link active" href="{{url('account-security')}}"><i class="ti-xs ti ti-lock me-1"></i> Security</a></li>
      <li class="nav-item"><a class="nav-link" href="{{url('account-notification')}}"><i class="ti-xs ti ti-bell me-1"></i> Notifications</a></li>
    </ul>
    <!-- Change Password -->
    <div class="card mb-4">
